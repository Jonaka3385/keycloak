...
public class ManagedWebDriver {
    ...
    private final AssertionUtils assertionUtils = new AssertionUtils(this);
    private final CookieUtils cookieUtils = new CookieUtils(this);
    private final PageUtils pageUtils = new PageUtils(this);
    private final WaitUtils waitUtils = new WaitUtils(this);

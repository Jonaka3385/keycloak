...
public class Profile {
    ...
    private static final Set<String> ESSENTIAL_FEATURES = Collections.unmodifiableSet(new HashSet<>(Collections.singletonList(Feature.HOSTNAME_V2.getUnversionedKey())));

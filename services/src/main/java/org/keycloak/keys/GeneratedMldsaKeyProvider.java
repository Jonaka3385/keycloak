...
public class GeneratedMldsaKeyProvider extends AbstractMldsaKeyProvider {
    ...
    protected KeyWrapper loadKey(RealmModel realm, ComponentModel model) {
        String privateMldsaKeyBase64UrlEncoded = model.getConfig().getFirst(GeneratedMldsaKeyProviderFactory.MLDSA_PRIVATE_KEY_KEY);
        String publicMldsaKeyBase64UrlEncoded = model.getConfig().getFirst(GeneratedMldsaKeyProviderFactory.MLDSA_PUBLIC_KEY_KEY);
